...
public class Base64yasuo implements Serializable {
    public static BufferedImage base64String2BufferedImage(String base64string) {
        ...
        try {
            ...
            System.out.println("base64String2BufferedImage"+e);
        }
        return image;
    }
    public static String imageToBase64(BufferedImage bufferedImage) {
        ...
        try {
            ...
            System.out.println("imageToBase64"+e);
        }
    ...
    private static InputStream BaseToInputStream(String base64string){
        ...
        try {
            ...
            System.out.println("BaseToInputStream"+e);
        }
        return stream;
    }
