...
import com.metoo.metoo.DTO.AudioRoomGiftMessageDTO;
import com.metoo.metoo.DTO.ObjectTool;
...
public class WebSocket {
    ...
    //<uid,userInfo>
    private static final Map<Integer,UserInfo> userInfo = new ConcurrentHashMap<>();
    ...
    public void connect(@PathParam("uid") Integer uid, Session session) throws Exception{
        ...
        List<UserMessage> userMessages = repository.takeOffLineMessage(uid);
    ...
    public void receiveMsg(@PathParam("uid") Integer uid,String message, Session session) {
        try {
            ...
            switch (type){
                case "AudioRoom":
                    UserInfo userInfo1 =repository.findUserInfo(uid);
...
//                    }
                    ...
                    Friend friend = repository.checkFriendShip(id,uid);
                    if(friend!=null){
