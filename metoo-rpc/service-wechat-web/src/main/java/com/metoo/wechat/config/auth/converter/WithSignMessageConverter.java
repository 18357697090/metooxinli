package com.metoo.wechat.config.auth.converter;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter;
import com.loongya.core.exception.LoongyaException;
import com.loongya.core.support.HttpKit;
import com.loongya.core.util.MD5Util;
import com.metoo.wechat.config.auth.security.DataSecurityAction;
import com.metoo.wechat.config.exception.BizExceptionEnum;
import com.metoo.wechat.config.properties.JwtProperties;
...
public class WithSignMessageConverter extends FastJsonHttpMessageConverter {
    ...
    public Object read(Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        if (encrypt.equals(baseTransferEntity.getSign())) {
            ...
            throw new LoongyaException(BizExceptionEnum.SIGN_ERROR);
        }
